...
const comptconnection = require('../config/COMPETITIVEtouchstone_config');
const { encode, decode } = require('html-entities');

module.exports = function () {
    this.fetchcompquesdetails = async (inst, questionid) => {
        //console.log(comptconnection);
        try {
            ...
            var qobj = {
                ...
                "subtopic_id": questionsubtopic[0].subtopic_master_id,
                "subtopic_master_name": questionsubtopic[0].subtopic_master_name,
...
const questiondetails = async (qid) => {
    ...
    return new Promise((resolve, reject) => {
        ...
        //console.log(sqlqry);
        comptconnection.query(sqlqry, (error, elements) => {
            if (error) {
                return reject(error);
            } else {
